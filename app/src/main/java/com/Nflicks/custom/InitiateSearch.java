...
public class InitiateSearch {
    ...
    public static void handleToolBar(final Context context, final CardView search, Toolbar toolbarMain, final View view, final EditText editText, final View line_divider) {
        ...
        if (search.getVisibility() == View.VISIBLE) {
            ...
            editText.setText("");
            toolbarMain.setNavigationIcon(R.drawable.ic_arrow_back);
            toolbarMain.setTitle("Product Selection");
            toolbarMain.getMenu().clear();
            toolbarMain.inflateMenu(R.menu.create_order_activity);
